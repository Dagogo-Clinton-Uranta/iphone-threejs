          ...
          <div className="mt-10 md:mt-20 mb-14">
            ...
            <p className="text-gray font-semibold text-center mt-3">Honkai Star Rail</p>
               ...
               <div className="hiw-text-container">
                 ...
                 <div className="flex-1 flex justify-center g_fadeIn">
                 <p className="hiw-text  g_fadeIn">New</p>
                 <p className="hiw-bigtext  g_fadeIn">Pro-class GPU</p>
                 <p className="hiw-text  g_fadeIn">with 6 cores</p>
                 </div>
